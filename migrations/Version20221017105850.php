 ...
 */
final class Version20221017105850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD event_id INT DEFAULT NULL, CHANGE name title VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP event_id, CHANGE title name VARCHAR(255) NOT NULL');
